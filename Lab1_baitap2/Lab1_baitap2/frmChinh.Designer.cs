namespace Lab1_baitap2
{
	partial class frmChinh
	{
		...
		private void InitializeComponent()
		{
			...
			this.bàiTậpToolStripMenuItem.Size = new System.Drawing.Size(52, 20);
			this.bàiTậpToolStripMenuItem.Text = "Bài thi";
			this.bàiTậpToolStripMenuItem.Click += new System.EventHandler(this.bàiTậpToolStripMenuItem_Click);
			// 
			// tToolStripMenuItem
			// 
			this.tToolStripMenuItem.Name = "tToolStripMenuItem";
			this.tToolStripMenuItem.Size = new System.Drawing.Size(62, 20);
			this.tToolStripMenuItem.Text = "Trợ giúp";
			// 
			// contextMenuStrip1
			// 
